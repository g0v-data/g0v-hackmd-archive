...
有大量資料希望推廣給更多人活用	Data Portal 資料整合並建立入可頁面供他人使用
	
大數據分析	
大數據分析 OLAP (Online analytical processing) 
...
想讓廣大的佛系民眾可以參與專案	Crowdsourcing 群眾協力與遊戲化
志工系統
引導機器人
NFT / Hypercerts / 回溯型獎助
學生獎勵系統

想促使政府做事的方式改變
- 這部分，想再進一步梳理出細項，基於 具體經驗案例，研擬 更適切的對策型態種類描述，從「如何驅動議題結構，因而改變？」的面向來歸納出路徑導向的對策種類，case：政治獻金、預決算內容資料、違章工廠地圖平台就學人口推估與校地轉型及民主辦學、好植地 用地盤點指認、開租資料 …等
...
台灣食品技師
https://www.facebook.com/groups/407071349350303?multi_permalinks=9314983485225667&hoisted_section_header_type=recently_seen
