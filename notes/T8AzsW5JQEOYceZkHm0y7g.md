...
![](https://g0v.hackmd.io/_uploads/rkg7_LyHRkg.png)
...
## 關於未來能做的方向
- 如何建立更多連結？可能可以找地方的民意代表
    - hybrid 模式是可以處理
- 如果完全沒有政府代表的參與，討論的事情是公共政策的話，那就要聚焦於對於參與者的影響
    - 藉由前測與後測的方式
    - 把 vTaiwan 變成終身公民教育的場域
- 建立屬於 vTaiwan 的分享模式
    - 目標：建立一個框架，讓講者可以將知識放到這個框架中，在30分內可以迅速讓參與者對齊。
