...
tags: digital-resilience, resilience, internet-shutdown, digiresi, civil-defense, 民防, 數位韌性松, DigiResiTh0n, hackathon, logistics, 基建, 基礎建設, civil defense
---
...
## jun todos
- [ ] set up a substack account as the mailing list services
- [ ] set up a `digiresith0n` google groups as the admin mail address
...
## 確認下次活動時間前
- [x] 將前次參與紀錄放到 [g0v 社群 @ NPO Hub 小松果](/Yef7YTSZS5q52nLPdNgz2A)
...
- [x] 開設 KKTIX 售票頁面
- [x] 把活動資訊放到 #g0v-landing-page channel
- [x] 把下次共筆的地點位置更新
