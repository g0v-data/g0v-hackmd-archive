...
tags: vTaiwan小松
---
# 20250219 vTaiwan 小黑客松
時間 Time ：19:00-20:00
地點 Location ：線上 Online
參與者 Participants: Peter, T, Allen, yuting, Josh
線上參與連結 / Link：https://meet.jit.si/vtaiwan

![](https://g0v.hackmd.io/_uploads/rkZNLyBA1l.png)
...
## 小小的分享
- 與 sensemaking開發者的 jigsaw 團隊聯繫上了！
    - 會在 2/24 or 2/25 在台北跟他們交流～
    - [Sensemaking 討論](/TDZybeTlR5iVwicR3f-x5w)
- [Japan's boom in randomly-selected mini-publics](https://open.substack.com/pub/demnext/p/japans-boom-in-randomly-selected?r=i4t12&utm_campaign=post&utm_medium=email)
    - 小型公共論壇在日本
        - 特色：抽籤
            - 美國也有地方的方式
        - 裁判員制度：在日本推行十年
    - 下週有機會可以跟Claudia Chwalisz 來交流！
    - 想要討論：
        - 每一場次的參與人數會有多少人？[name=allen]
        - 會不會有被拒絕的情況？[name=allen]
        - 討論會不會使用數位工具？討論的紀錄是否會放在網站上？[name=T][name=allen]
            - 呼應 CFJ 訪談的發現：對於長者而言，數位工具不是一個最方便的方式
        - 舉辦活動的頻率 [name=T]
            - 議題小聚 #1 提出來的構想：如果要納入長輩等不同參與者的意見。
        - 與地方政府合作 [name=peter] 加強版的公聽會 [name=T]
            - 5/16 活動測試
- TWNIC 進度更新
    - 目前確認在 2025/4/2 （週三）晚上 6:30-9:30 於 TWNIC 舉辦活動
    - 主題會訂為：打擊網路詐騙，還缺哪一步？
        - 收集大家對於目前打詐政策與行動的看法
        - 銜接下一場的主題：打擊網路詐騙，可以做什麼？
    - 資訊來源：[議題小聚討論-網路黑魔法防禦松](/_FMPlV_LQS-ZzRQL5t4tzg)
    - 與交大傳播學院陶振超教授討論，如何招募多元的參與者
    - 新增共筆：[議題小聚#3 w/ TWNIC](/oNucqzRLQDCE7sK5JEZX1Q)
### Allen 分享的 argdown 
- [argdown](https://argdown.org/guide/a-first-example.html#sketching-the-argumentation)
    - 利用 markdown 語法來生成討論的視覺化
- 其他類似 argdown 的工具應用？[name=josh]
    - 感覺是將論點的層次整理出來。[name=peter]
    - 對於觀眾來說可能還是比較難觀察出結果。
    - 有一個 use case 可能蠻適合的：threads [name=peter]
        - 也可以結合 reddit 或 twitter
- 目標還是討論時要有系統（ARE, argument / reason / example）
- 使用情境可以分成兩種族群：[name=T]
    - 熱衷議題討論整理的公民
        - 類似 cofacts，由社群熱心公民來結構化整理大家的論述。(事實查核)
    - 普羅大眾
        - 用類似 新聞小幫手 的插件方式，方便將上述整理好的論述分享到 FB, YT 等社交平台討論區。(協助闢謠)
- 審議活動時的練習
- 自動化整理與結構化意見，以目前的技術來說有點困難 [name=allen] 第二點或許可以來整理公眾人物的發言，用樹狀圖整理
    - 感覺可以用來整理 threads 上面的文章
        - 突破同溫層的狀態
- 使用情境：
    - 討論平台，並利用 threads 來做推廣
        - 邀請大家來做討論
        - 定期整理討論結果，發文
    - 決定我們實體討論的議題
...
## 七天國定假日討論
- 最近藍白將七天國定假日作為下一個會期的優先法案，或許可以來用議題小聚找大家來聊聊如果真的新增七天的國定假日，可以放哪些日子。[name=ronny]
- [vtaiwan 議題小聚：七天國定假日討論](/LKgsZe7MTHaBPRG1GAdRLw)
### 待辦事項

## 2/22 大松活動
- [簡報](https://docs.google.com/presentation/d/1sF_sU3uG23S9pVo6ihZ7Fi5qccjUkhQ9u_-GebCPEWo/edit?usp=sharing)
- [2024022大松共筆](/5YEDm5PCTtK8I_HCOxYu9w)
- 出席
    - peter
    - 宇亭
    - eli 
...
- 宇亭提議
    - 延續 vTaiwan 的101, FAQ, 邀請對 vTaiwan 有興趣的人來幫我們看看要新增哪些問題和回答。從新手的觀點獲取需求，完善文件。
        - action list: 列出問題
        - 
