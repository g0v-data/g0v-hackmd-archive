...
tags: vtaiwan小松
---
# 20240313 vTaiwan 小黑客松
時間：19:00-21:00
地點：線上
參與者：Crystal, eli, peter, josh, 欣慈
...
- 我可以負責打好共筆～[name=peter]
    - 3/20[name=]
    - 3/27[name=eli]
    - 4/3[name=josh]
        - 想做一些關於開發的 brainstorming 
    - 4/10 Peter 回歸！！[name=peter]

## Glen Weyl 敘述修改
- Plurality的書要出版了，這週要截止，意外發現他們的寫手是這樣寫vTaiwan的，大家覺得我們要幫忙修改嗎？ “While these (attempts of vTaiwan) were generally viewed as successful by all parties, the intensive effort required, the lack of mandates for government to respond and the somewhat narrow scope has led to a relative decline of the platform recently.”[name=josh]
- 修改的方向：我覺得可以借用 Glen Weyl 在他的演講裡提到的說法：vTaiwan 成功從一個體制外的平台演變成體制內的 Join 平台，確保政府回應的強制性，至今 Join 平台也很活躍，然而 vTaiwan 本身的定位也因此較不明確，正在探索轉型的可能性 [name=tzu sheng]
    - 釐清 vTaiwan 與 join 平台的關係 [name=mrorz]
    - 目前版本：
...
- 感覺四月可以先進行一個共識工作坊？
## 監察院人權會邀請
- 從豆泥處得知，監察院人權會想辦AI人權相關的研討會，想聯繫vTaiwan進行分享 [name=peter]
- 監察院在7/12舉辦論壇，想邀請vTaiwan來分享生成式AI審議式民主的東西～但公部門凡事都要簽准才算數，因此想先詢問您的意願後，我們往上簽報
- 論壇的主題感覺是「生成式人工智慧與人權」，論壇主要分三大場次：
    - 生成式AI與人權風險
    - AI的國際趨勢與規範
    - 如何與AI達到共榮及兼顧人權
...
- 3/9 完成了 g0v Summit 2024 的投稿
    - 5/4-5/5
    - [vTaiwan 復活之後的嘗試與挑戰](https://summit2024.g0v.tw/prj/Pgcm4d53zOMYPGWa5lbABH6oKN3616)
        - 內容： vTaiwan 社群在經歷疫情開始之後，因為活動中斷導致社群參與度低迷與參與者流向其他專案的困境後，在 2023 年以 OpenAI 的 Democratic Input to AI 專案重啟。並成功舉辦社群活動與完成相關計畫。但是在此之後，vTaiwan 也遭遇到一些挑戰，包含無法重啟與政府單位的連結、社群參與能量與外在合作機會出現落差、新的社群成員與既有專案的legacy產生隔閡等問題。在本場活動中，我們將分享vTaiwan 復活之後的嘗試與挑戰。
    - 如果有上（第一批公布會在3/25)再來邀請大家共同編輯簡報

### 開放政府行動方案
- 下一階段[開放政府行動方案](https://join.gov.tw/policies/detail/cbba96d5-537e-4e3e-a18a-5ddc61fa8bfc)徵集在3/8截止
- 3/8 晚上趕在截止前送出[提案]()
