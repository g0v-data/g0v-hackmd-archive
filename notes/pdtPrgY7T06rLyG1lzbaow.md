...
- 實體書書名拍照
    - Todo：拍照放在松江路的書
    - Done：6/15 永和路的書 https://photos.app.goo.gl/ZWk2SMQANFeAGme37
- 把書名建檔
    - 檔案工具選擇
    - Airtalbe
        - 優點：比 Googlesheet 好
        - 缺點：
    - 電子檔案存放區
        - https://drive.google.com/drive/folders/0B9KyxXC_y1sLLVIyc2kzUWtkeEE?resourcekey=0-Qb_w4zjXlQyhLauEKr6uag&usp=sharing
    - 要如何也同時納入
