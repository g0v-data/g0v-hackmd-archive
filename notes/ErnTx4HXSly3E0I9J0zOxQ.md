...
<iframe width="560" height="315" src="https://www.youtube.com/embed/E958kU8eoyE?si=0Y_g2AMc06wiPGRw" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>

三分鐘提案影片：https://youtu.be/E958kU8eoyE
...
- 兩側建築物與建築物之間的寬度
    - 東北西南向道路：16 公尺 (使用 Google Map 測量工具推測)
    - 西北東南向道路：18 公尺 (使用 Google Map 測量工具推測)
- 改造階段：雙線車道改為單線車道
- 改造階段：單線車道改為車流轉向
    - 留設區最窄處的寬度：至少有 20 公尺
...
- 大型道路
    ...
    - 道路的車道數量，3 車道以上，多數行人基於風險意識而不會任意穿越
- 軌道設施，例如地面鐵路、地面捷運
- 坡地林地
- 河道與堤防
    - 河川治理線
    - 街區內的水圳與排水渠道，不一定都是邊界，可能是包裹在邊界內，主要基於走到河邊、水邊，的難易程度，容易到排水渠道旁，這樣的排水渠道就不是邊界
        - 例如臺中市柳川、高雄市幸福川
...
街區內的跨街廓路徑，有什麼特點？
- 比起也可以跨街廓的主要道路的行人空間，例如臺北市的忠孝東路，此區域的街區內跨街廓路徑，則像是「復興南路一段135巷-瑠公公園-頂好廣場-龍門廣場」、「大安路一段」，這些路徑因為尺度也比較小，所以行人可以遊逛兩側的店家數量，會比主要道路行人空間僅一側 (因為行人無法輕易到達對面) 來的多。
...
臺中市主要排水系統，陸續補上可能可以做為參考對照的案例，針對線型 (排水箱涵、舊鐵路) 路廊推動人本交通化的案例，我目前想到的像是臺北市瑠公綠廊有取消其南側汽車通行
- 討論串：https://www.facebook.com/groups/474536628587982/posts/538391568869154/
- 線上地圖：https://drive.google.com/drive/folders/1clbbTsBsQfX_x46u6jQ_SxujRhjxG4u5?usp=drive_link
...
2025.07 延續 Ju Ying Peng 繪製台南廓界定成果，開始嘗試繪製「臺南市的跨街廓路徑」
- 從大型公園作為起點
    - 從 水蘊萍公園 出發作為起點，開展長距離跨街廓路徑繪製線條，例如東至仁德國中、北至鹽水溪&小北棒球場群
    - 從 台南公園，往北至 新寮鎮安宮
- 可能要先放入：
    - 行人可穿越鐵路的節點位置，用衛星圖比較難直接判斷；例如台南運河的穿越點就蠻明確可直接在繪製過程中判讀
    - 鐵路地下化之後的平面道路方案 https://www.rb.gov.tw/showpage.php?lmenuid=5&smenuid=14&tmenuid=447#gsc.tab=0
    - 臺南捷運站位置 https://traffic.tainan.gov.tw/RTO/StaticPage/ScheduleLine
...
高雄市_高雄車站週邊探討
- 輔助地圖：https://maps.app.goo.gl/513br99pMe91tKY66
