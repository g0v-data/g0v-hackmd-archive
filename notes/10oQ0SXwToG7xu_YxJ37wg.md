...
- [ ] CCC 的 Cofacts 遊戲 (結合台灣宮廟文化體驗+假資訊)
    ...
    - [x] 神明版乖乖 + 神桌背板 (A3)
    - [x] 電子詩籤+籤筒 (遊戲題目)
    - [x] 題目感測裝置 (魔法陣/USB)+RBG 燈條 (USB)
    - [x] 螢光燈條 (USB)
    - [x] 筆電
    - [x] 遊戲作答按鈕裝置 (ABCD/Yes,No)
    - [ ] 延長線
    - [x] USB 豆腐頭
    - [x] 其他擺飾物 (台灣意象小物 : 春聯、小點心)
    - [x] 遊戲說明牌
    - [x] 貢獻箱- 現場提供贊助Cofacts的帳戶或QRcode資訊 (不知道要放哪, 先列在這裡待會議討論。前情提要 : 在CCC有提供Donate箱, 做為下次CCC擺攤的籌備基金及購買禮品 )
- [x] 局部上光 bil 名片
  - [x] 加中文「比鄰」小字
- [x] 更新英文版網站 news
- [x] 文宣更新與印刷
