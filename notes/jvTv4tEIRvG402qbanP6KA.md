...
## 媒體小組的疑問
 - 新聞稿的英文翻譯是誰負責？媒體小組內部處理？summit會有翻譯組？[name=YC]
     - 嗨嗨這裡是議程組 peter，新聞稿的翻譯應該可以問問看議程組這邊的翻譯夥伴，感覺可以先開個 ticket
 - 新聞稿發布前是否要給媒體小組以外的人審稿？流程是？[name=YC]
 - 這次會有記者會嗎？[name=YC]
 9/22宣傳組會議Peter：不一定。可以帶到大松、跨組會議討論，畢竟辦記者會需要一定的人力和能量。　　
 - 這次要安排講者專訪嗎？[name=YC]
 9/22宣傳組會議Peter：過去好像都是媒體主動來詢問有沒有專訪機會，或是社群裡的夥伴幫忙牽線。如果媒體組想要主動幫忙聯繫，也可以。
 - 記者的票務處理時程？（關係到何時要發採訪通知給記者）[name=YC]
 - 活動當天受訪窗口是總召？[name=YC]


## 其他
找參考資料時，看到宣傳的其他組可以參考的東西
 - 社群組：會後感謝文