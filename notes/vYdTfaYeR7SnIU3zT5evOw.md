...
pm5: 補充之前的[「社群代表坑」的治理原則？](/b4WDfv8RTpyeixnsn-GwkA)筆記。

### 2024/07/20 大松重寫

> drafted by isable, pm5

g0v 社群是一個多中心、自由參與的社群，之所以持續協作，有賴社群參與者間、各專案、各工作小組間的互相尊重，與對社群規範的遵循。社群規範，除了有要求參與者一律遵守的[零時政府社群守則](https://g0v.tw/intl/zh-TW/coc/)，還有一些統稱為「社群治理」的 know-how，包含提案、社群媒體發文、公開專案與徵求協作、對外徵求資源與曝光等等，匯整了社群一路摸索調整，試行到目前為止，較符合社群行動共識的操作流程。以下列舉這些治理機制，供社群參考。

## 大原則草案
- 本原則應可經過社群粗略共識修改
- 任何中心/task force，管理者名單應公開，且盡量隨時保持最新狀態
- 任何中心/task force，加入機制應清楚明訂
- 任何代表性發言，發言機制應清楚明訂（請參考[零時政府媒體政策](https://g0v.hackpad.tw/g0v-Media-Policy--Rbpc5FiUyA5)）

> 我覺得[開放街圖組織編輯指南](https://wiki.osmfoundation.org/wiki/Organised_Editing_Guidelines)的範疇與原則還蠻值得參考的。具有某個適當程度的代表性，也許並不是問題，而是要依循什麼原則來進行才能對社群與組織都有良性的幫助。[name=Pomin Wu]
> 讓適度的代表幫助社群 +1 [name=chihao]
...
- https://github.com/orgs/g0v/people 
    - (未登入只能看到 91 人，因為有很多 team 是設定非公開的)
- slack channel: #g0v-github

討論中的治理機制
- g0v github 社群規範討論
    - https://g0v.hackmd.io/1wFAJoQeTrmw9pnjcqPkXg
- g0v GitHub 申請規範 v0.1
    - https://g0v.hackmd.io/I4_oYRIvT9S0RKufKKKKvg
...
> [name=ky] 這不會變成「有人可以代表g0v」嗎XD

簡報素材支援共備
- 專案圖鑑-簡報版：https://g0v.hackmd.io/@jothon/intro/https%3A%2F%2Fg0v.hackmd.io%2FpraEhMvpR_2ZNiNNSO9zBA%3Fview
...
## g0v Slack
### 成員
[slack admin 列表](https://docs.google.com/spreadsheets/d/1xg6Cb28J7IYTwonrqqBR2mQ2V1dqP3K-K9dZgLmy4mQ/edit#gid=0)
[g0v slack 治理機制討論](/rHe3Lfh_S3yhtRawnliSIg?both)
slack channel: #g0v-slack

## g0v IRC

請見 [g0v IRC 現況](/@YMAapC0RTZaurbgCZtn72w/SJn3lVIFd)

## g0v.news
2019/7/1 前為 OCF 專案，現為社群坑
[g0v.news 社群治理／g0v.news governance](/t5qvF5BARUa0yEKYdNG7QA)
### 參考文獻
[g0v.news 改名最終方案](/BMPECozKSlqpmDLbARA75Q)
[g0v.news 公告](https://g0v.news/ancm-b7651820db3a)
[g0v 新聞中心 2.0（？）（草案）](/THKRsDsNRXGsa_0zFUn3Gw)

2019/8/16更新
[g0v.news 社群治理／g0v.news governance](https://g0v.hackmd.io/t5qvF5BARUa0yEKYdNG7QA)

## g0v.tw 後勤中心 facebook 公開社團

[社團網址](https://www.facebook.com/groups/g0v.general/)
...
### 2023/4/4 [可疑（假）帳號因應討論及措施](https://g0v.hackmd.io/oc69pb7DT3Ky24X8mSCS0w)

## g0v facebook 粉絲頁

### 2019/10/20 [新治理機制](https://g0v.hackmd.io/THKRsDsNRXGsa_0zFUn3Gw?both)
...
主要擁有者：kirby
擁有者：clkao, ipa, ronny
管理成員：au, Bropheus Huang, ETBlue, 孝先, Macpual, YuTin, ichieh, tmonk, chihao, bess, seangau, jothon, daisuke
...
Current admins:
- https://twitter.com/ballPtPenguin
- https://twitter.com/divyasiddarth
- https://twitter.com/patconnolly
- https://twitter.com/theengineer
...
- 申請請至 👉 https://g0v.hackmd.io/zNfe2MGfTrWo_5GZI0E5pQ
...
#### 標準：內容違規標準
- 類型一：頁面內容違反 g0v CoC 行為守則
    - case: 2021.08 已發現有網站操作教學的共筆，但題材內容使用 18+ 圖片、成人網站等
- 類型二：廣告
    - 如何判斷？ 
    - case 
...
- 「超級管理員」要做什麼？
    ...
    - 進行刪除動作之前
        - 超級管理員要不要頁面截圖留存？
        - 若僅刪除頁面部分段落或圖片，是否需要留下提醒用字（「原內容段落違反ＯＯＯＯＯ，請勿再張貼於 g0v.hackmd」）
    - 是否需要通知該 g0v.hackmd 的筆記持有人
        - 目前 g0v.hackmd 的筆記持有人，有些人的帳號會登錄 email 但這個不是強制的機制，所以有些人也沒有聯繫方式 [name=bess]
        - 明確是洗版機器人的帳號
    - 撰寫處理紀錄
...
case:
- 20220313 Rentea 第零次股東大會 X 暖屋活動 https://www.flickr.com/photos/g0v/albums/72177720297364492
...
### 決策機制
- 揪松團工作清單，公開可瀏覽網址如下：
    - https://trello.com/b/f8gWnjeC/g0v-jothon-organizer
- 揪松團透過每週例會，共同討論執行事項
    - [揪松團每週例會會議，旁聽登記表單](https://forms.gle/DTsGV2P6ToBae5oR8)
...
[開放治理機制](https://g0v.hackmd.io/Ozy9SKwORXOIBFiGdSkLtw#)
...
> [name=ipa chiu]目前新手文件應該如海濤般無窮無盡，應屬 mutiple points of failure 的看不完狀態.....
...
> [name=chihao] 因為是「OCF 的專案」，所以算不算社群專案？XD 因為 2018 年與 OCF 國際交流的夥伴和社群成員一起到紐約，發現在行程中蠻需要「代表社群」發言，有時候是應邀的正式場合（例如跟開放社會基金會介紹 g0v），有時候是非正式場合、個人交流時（例如在紐約參加 Personal Democracy Forum 的時候跟會眾聊天），因為就只有這麼多 g0ver 實體站在那裡跟其他人對話，被問到「g0v 是什麼」之類的問題，好像就會需要「代表社群」。
> 
...
> [name=pm5] 就幾次參加國際交流計劃底下的活動的經驗來看，[這是](https://ocf.tw/p/intl/) OCF 的一個計劃：在網站上，這個計劃是「財團法人開放文化基金會 主辦」，並且這個計劃底下也舉辦過與 g0v 看起來不直接相關的活動。實務上 g0v 社群專案會有不同的開放程度。如果把 OCF 的國際交流計劃視為來黑客松裡提案過的 g0v 專案，它的情況大概是參加的 g0ver 可以事先溝通在一場活動裡要負責什麼事情與得到什麼結果，但不能例如說參與「決定共同參加活動的成員有哪些人」的流程。
> 
...
> [name=bess] Code for All 的參與機制是否也需要釐清，目前是以 g0v 名義成為 Code for All 成員，不過實際窗口是 OCF 國際交流。 
> 
> [intl discussion 2018-11-11](https://g0v.hackmd.io/7zKnMuMiQ3iLVxbAg-4RKw)
> 
  2019.7 update:
  由g0v intl 接手與code for all 窗口聯繫並參與定期會議。
  [Code for All x g0v](https://g0v.hackmd.io/UPGwwBNkStKZFja2Neikkw)
  

## g0v.news
> [name=chihao] 因為是「OCF 的專案」，所以算不算社群專案？XD 不過名字裡面又有「g0v」字樣，好像會有不一樣的「代表性」問題？XD 專案從 2016 年底（？）運作到現在，也許可以一併加入這次 mapping 的閒聊，梳理一下歷史和脈絡？
> 

> [name=pm5] 在[網站上](https://g0v.news/about)這「是開放文化基金會專案」。當然這不代表它不能也是社群專案。
...
> [轉型討論](https://g0v.hackmd.io/BMPECozKSlqpmDLbARA75Q?edit)
> [g0v.news 後續治理討論](https://g0v.hackmd.io/t5qvF5BARUa0yEKYdNG7QA)

## g0v 公民科技創新獎助金
> [name=chihao] 也是個名字裡有「g0v」的專案。這是個揪松團的專案？XD
> [name=ipa] 這列在揪松團了喔。「揪松目前辦理大松、基礎松、獎助金。」
> 
