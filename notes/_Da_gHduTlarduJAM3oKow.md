...
To get projects that are stronger and can be scaled upwards, npm should be utilized. This is an excellent move to make. As far as lightning CSS is concerned, it can also be installed via npm commands taking into consideration dependency  much better versioning and build integration process.
