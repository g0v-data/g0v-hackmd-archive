...
### 奈及利亞分享圓滿結束！
- Tunani Institute 
- 分享影片連結：https://youtu.be/arWgj3FhKGU?si=_RSFRmesM1l_qd2u 
- 投影片：https://docs.google.com/presentation/d/1EfIpme-puy-AZby1N9OOKafSqtaF25L3hbMoTlKlBg0/edit?usp=sharing


## 審議大會
- 報名連結：https://docs.google.com/forms/d/e/1FAIpQLSfZ7ZtrXB841V8Jv7eY0fFvB8N9QvihaNEoO1t8H_daKxt6oQ/viewform?usp=dialog 
    - 使用者回饋：目前的設計容易漏掉
- 目前議題投影片初稿：
https://docs.google.com/presentation/d/18qmdja3GP4ZIOA0HZbLoyyi6U3DU2SypWjA7jM_4-fs/edit?slide=id.g3f06012c277_2_2#slide=id.g3f06012c277_2_2 
-  正在跟 TCA 昱均精修
### 回饋：
-  要將這個簡報轉成完整的報告投影片 [name=peter]
    -  介紹 vTaiwan 
    -  介紹 TWNIC 
- 目前的題目過於深奧，需要經過調整
- 要將目前覺得不足的法律內容納入
...
### 待辦
- 7/11 寄信給報名的參與者，邀請他們填寫 polis 的意見。
- Mentimeter 正在製作中
...
### hear the room 的討論
- Hear the room 是否不適合直接進入到這麼嚴肅的討論過程？
    - 可能還是需要更多的測試
- Mentimeter 為主，Hear the room 為輔
#### 可行的實作方案 
方案一 [name=tim]
- Hear the room 做的事情是將論述轉為論點
- 只輸出論述，而先不要使用 live 的同意 / 不同意
- 好處：可以作為測試聲音擷取與意見產生的方式
- 壞處：無法發揮 Hear the room 的全部功能，參與者可能沒辦法知道相關的內容

方案二（方案一的變形）[name=peter]
- 利用 hear the room 的功能搜集意見，貼到 mentimeter 上
- 好處：可以作為測試聲音擷取與意見產生的方式，也可以透過轉貼到 mentimeter 上與參與者互動
- 壞處：無法發揮 Hear the room 的全部功能
方案三 [name=peter]
