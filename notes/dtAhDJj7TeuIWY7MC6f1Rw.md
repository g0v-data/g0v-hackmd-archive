...
:::
OpenTransLive 是一套能夠即時擷取音訊、轉錄成文字，並將文字內容同步翻譯成多種語言的工具。主要面向使用者為**活動主辦方**，提供現代化的網頁介面，使用者能於後台一鍵啟動麥克風收音，並將連結提供給會眾查看翻譯字幕，或使用獨特的 YouTube 整合介面，為直播或影片提供同步字幕。

本系統採用客戶端與伺服器分離架構，利用 WebSocket 技術達成低延遲的即時通訊，並可彈性切換多種語音轉錄引擎（如 WhisperX、OpenAI、Groq）。
...
因應多國參與者的語言需求，於現場架設投影幕及電視投放華、英、日、韓四語同步翻譯字幕，現場約 80 人。

![](https://g0v.hackmd.io/_uploads/B1b40_U4lfe.png)

#### 會後檢討
- elevenlabs 的自動語言辨識有時候會卡住，較穩妥還是手動切換語言

### 2026/04/24 台灣日本研究院年會

於活動現場架設 華/日 雙語翻譯，並投影於投影幕下方，現場約 40 人。

![](https://g0v.hackmd.io/_uploads/SJgPR0IElGx.jpg)

#### 會後檢討
- 講者語句較為破碎時，會大幅度影響翻譯的品質，於會後增加機制篩選冗言贅字，並組合過短語句再送模型翻譯
...
### 2026/06/27 STS 年會 ── Panelist

於 STS 年會開幕 Panelist 架設 4 國語言同步翻譯（華英日韓），講者以英語為主，將華語字幕固定投影在螢幕下方，並提供 QRcode 讓會眾可以掃描在自己手機觀看。

![](https://g0v.hackmd.io/_uploads/r1-3fvwkXfg.jpg)
![](https://g0v.hackmd.io/_uploads/HJx_PvJXGl.jpg)

#### 會後檢討

- 投影三行字出來會比兩行字更易閱讀，但要視現場投影幕大小及空間深度而定
- 人名、專有名詞仍是問題，通常是轉錄出來就是錯的，目前僅能靠 Text Mapping 盡量處理
