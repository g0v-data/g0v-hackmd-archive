...
### Rights Con 投稿
- 已經完成投稿，預計 8 月可以獲得結果
- [RightsCon 2025 vTaiwan Proposal](/@Pno233SAS8G5UfL5OvSRmA/HkJstRKER)
### TICTeC 分享
- 一場工作坊與一場短講
...
- 新的連結：9/25 在柏林
    - 德國貝德斯曼基金會會舉辦數位民主的研討會

### FNF 邀稿
- 目前已經與 FNF 完成簽約，會寫一篇文章刊登在 FNF 的網站上。
- 架構
    - 前言：AI 風險管理的問題：AI RMF > 如何納入多元利害關係人的意見。
    - 如何解決問題？vTaiwan 多元利害關係人的參與機制。
    - 實作：OpenAI 計畫
    - 將 AI 導入：TttC 介紹與實踐
    - 結論
### STS 年會分享
...
- [投影片](https://docs.google.com/presentation/d/1x5bUcXWEyu9r8gYyOUj7pep6Ue44WqhhmbnCD_lkK7w/edit?usp=sharing)
- 法律的角度如何看 AI 造成的風險或危害？[name=yuting]

### 完成 medium 架設
- 說嘴很久的[部落格](https://medium.com/@vtaiwan.tw)終於完成架設拉！！！
- 下一步：如何與 vTaiwan 網站結合。
    - 可以發中文與英文
    - 中文協作，英文版本可以連結到[英文網站](https://info.vtaiwan.tw/)
- 目前預定要發的文：
    - 工作坊的新形式：即時的分群＋在物理空間實體化意見光譜 [name=josh]
        - 英文要好好想一想名詞
    - 參與 TICTeC 與參訪的內容 [name=peter]
    - 來問 shuyang 準備短講的部分

### 社群貼文
- 治理機制可以之後慢慢想。
- [工作坊圓滿結束！](https://docs.google.com/document/d/1gL9tbkKyhzBeyESLmCESIiqx8r7kiBKEiHft_GDxDZw/edit?usp=sharing)
- 
