...
再敘述至此前，請讓我為您闡述，這些程序與協議建立的依據以及證據。

*BAT(Basic Attention Token)是一套曾經發起的類似的區塊鏈專案，但與我們的模式將有差異。

*要注意的是鑄幣基礎，也即代幣，並非金錢，真正讓這些代幣轉為真正的流通貨幣，需要一套所有人認可的程序與協議，而這套程序與協議的基本要求是：近似牛頓的數學原理，即它並不因個人或集體的意志所變，也即：其實它並不需要公眾的認可 — 所以它能得到所有人的認可，它應該是不證自明的，源於更高的真理以及基本的共同原則。再敘述至此前，請讓我為您闡述，這些程序與協議建立的基礎以及證據。
