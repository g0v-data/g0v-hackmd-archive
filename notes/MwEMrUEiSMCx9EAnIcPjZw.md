...
## 專案內容
### Project Vision 
- 在面對面審議或實體討論中，「誰拿著麥克風，誰就擁有話語權」。但在許多文化脈絡（包含台灣本地的實踐），沈默不代表沒有意見，而是沒有適合的表達介面。本專案嘗試解決「講話者的獨裁」問題，打造一個工具，讓 實體討論現場的聲音，可以即時轉化為可被所有人投票、分群與收斂的意見結構，並與 Polis 式的審議流程無縫銜接。目標不是取代討論，而是讓沈默多數也能在不打斷討論的前提下，實質參與共識形成。[josh]
