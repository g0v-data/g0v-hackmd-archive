...
日期 Date：2025/9/13, 14
時間 Time ：9/13-9:30 - 20:00, 9/14-9:30-12:30
地點 Location ：
...
- 我們的目標：希望邀請使用者一起來玩玩看 sensemaker，一起來測試用 AI 分析大規模的意見是否準確，並且看看可以應用在哪些場景之中。
    ...
    - 私たちの目標：ユーザーの皆さんにSensemakerを試していただき、AIで大規模な意見を正確に分析できるかを検証し、さらにどのような場面で応用できるかを一緒に探りたいと考えています。
    - 우리의 목표: 사용자들이 Sensemaker를 직접 사용해 보고, AI가 대규모 의견을 얼마나 정확하게 분석할 수 있는지 시험하며, 어떤 상황에 적용할 수 있는지 함께 살펴보고자 합니다.
- 不能編輯 hackmd? 沒關係，歡迎來這個 [google doc 工作區](https://docs.google.com/document/d/1jSoJy8bwp9gNKJNtqv1JNnNvKSfsfv_eYuvGZ4aT8HM/edit?usp=sharing)協作
    - Can’t edit HackMD? No problem, feel free to join this [Google Doc workspace](https://docs.google.com/document/d/1jSoJy8bwp9gNKJNtqv1JNnNvKSfsfv_eYuvGZ4aT8HM/edit?usp=sharing) for collaboration.
    - HackMDを編集できませんか？大丈夫です。この[Googleドキュメント作業スペース](https://docs.google.com/document/d/1jSoJy8bwp9gNKJNtqv1JNnNvKSfsfv_eYuvGZ4aT8HM/edit?usp=sharing)での共同作業にぜひご参加ください。
    - HackMD를 편집할 수 없나요? 괜찮습니다. 이 [Google](https://docs.google.com/document/d/1jSoJy8bwp9gNKJNtqv1JNnNvKSfsfv_eYuvGZ4aT8HM/edit?usp=sharing) 문서 작업 공간에서 함께 협업해 주세요.
- 請參考以下的使用說明，一起來玩玩看！
...
* [SenseMaker報告-Uber爭議-華文](https://hackmd.io/-EpjEA0dQ3-nNspbxymaSg?view)
* [SenseMaker Report - Uber Controversy - English](https://hackmd.io/TV29KodMRE-HFtXfDYTyVg?view)
