...
# 地理資料格式轉換工具
:::warning
Mapfessional 蒐集各種繪製電子地圖的方式。筆記原則：一行傳送門，請附上完整或短網址，工具直接用/教學文都可哦。
:::

gps2map｜用移動畫地圖
http://gps2maps.de/
https://news.gamme.com.tw/1383001
航跡分享社團: https://www.facebook.com/groups/1631034120482669/
Real-time maps for live events https://blog.mapbox.com/real-time-maps-for-live-events-fad0b334e4e
...
GoogleMyMap 點線面: https://www.google.com.tw/intl/zh-TW/maps/about/mymaps/
localwiki 點線面+community story: http://www.slideshare.net/TajfunInsulo/20140712-localwiki；https://localwiki.org/regions
...
KML2csv: https://github.com/RedbirdTaiwan/kmz2xlsx
shp2geojson: http://gipong.github.io/shp2geojson.js/
線上 Geojson or 其他 GIS 格式產生器: http://geojson.io/
Convert to GeoJSON: https://ogre.adc4gis.com/
用 google 搜尋「ogr2ogr online」可以找到這個站
Xml 轉檔成 地理格式
http://gis.rchss.sinica.edu.tw/qgis/?p=472
如何使用開源的QGIS軟體，以政府開放資料為例進行示範，將CAD檔轉換為GIS格式(SHP及KML)
https://www.facebook.com/groups/718089658359103/permalink/2399992693502116/

geodata/file2map｜丟檔案畫地圖
用EXCEL做地圖: https://www.facebook.com/chou.bigwhite/posts/10213988195085721
...
Excel Table 2 KML in Google Earth: https://goo.gl/GKi4tj
Adding Excel Data to Google Maps: https://www.youtube.com/watch?v=SK4HNA5fZ2E
Database2LocalMap
CartoDB: https://cartodb.com/
Google Spreadsheet 2 Map: https://goo.gl/LQM7m7
Google Fusion Table: http://goo.gl/INMDGT
Google Fusion Table 匯入 KML: https://goo.gl/u3Yqps
Datamaps.co https://datamaps.co/
DocuGIS https://docusky.org.tw/DocuSky/DocuTools/DocuGIS/
CSVmap(檔案內含經緯度座標,運用GitHub畫出地圖): http://ronny.wang/blog/post/39728713
撈出資料 OpenStreetMap Database: https://osmtw.hackpad.com/-OSM-VnjVOhWBZuO
建築物(kml → GeoJson): ？
CADmapper(Three-dimensional CAD files): https://cadmapper.com
shp2fusiontables: http://shpescape.com/
GeoPDF: http://gis.rchss.sinica.edu.tw/geopdf/
輪廓簡化 Mapshaper:  https://mapshaper.org/
...
社會經濟資料統計地圖：https://semap.moi.gov.tw
一些主題地圖案例
...
coding2map｜寫程式畫地圖
概說簡報與影片 by Ronny
https://g0v.hackmd.io/@chewei/gis/https%3A%2F%2Fg0v.hackmd.io%2FHLyJ6GN5ToK_e9x3ok4WCw
...
歷史名人移動軌跡: http://goo.gl/0khrCF
Time Information System Software: http://www.hutime.org/

crowd2map｜群眾協作的地圖工具
OpenStreetMap資料來做主題地圖: https://mapcomplete.osm.be/
群眾通報類(群眾貢獻,設施損壞,上傳照片): https://goo.gl/9D3ENY
內政部資訊中心TGOS地圖協作平台: http://tgos.nat.gov.tw/MapSites/
Real-time Collaborative GIS Tool: https://goo.gl/tdHO5M
spreadsheet2googlemymap: 案例-台灣COVID-19 確診足跡地圖

aerial2map｜航拍畫地圖
OpenAerialMap: https://openaerialmap.org/
MapKnitter - Make maps from aerial photos: http://mapknitter.org/
教學活動: https://sites.google.com/view/2017-tw-north-ngo-uav/

image2map｜地圖影像定位
Map Warper: https://g0v.hackmd.io/-yuqdMq4Tme7asTvc_CZtA
...
data2realmap｜實圖生產
osmdata2papermap: https://www.facebook.com/openstreetmaptaiwan/posts/1603781279739930
osmdata2tactilemap: https://www.asla.org/2017studentawards/335292.html

indoormapping｜室內地圖
常見的校園樓層開展圖 https://g0v.hackmd.io/4_ycufouSMGkWx1EbyIrhw
...
需要線上展示
無須公開展示
是否希望別人打包你的製圖成果，釋出 raw data
例如若希望別人打包你的製圖成果 localwiki 就不太適合囉！匯出功能尚未建構
是否希望群眾協作？
例如運用 GoogleMyMap 作為協作工具
或是用 sheet 作為資料共筆區，填寫經緯度，但就無法處理 polygon 類型
是否需要進行地理分析？
是
carto 的後台有一些工具可以運用
QGIS 軟體也很適合
本項需求要與前三項一起考量，例如：
carto 與 QGIS 都無法協作
carto 易於發佈線上地圖，也可釋出下載管道；QGIS 要使用套件來發布線上地圖
...
主題地圖與 OSM：https://osmtw.hackpad.tw/-OpenStreetMap-VnjVOhWBZuO
主題地圖案例蒐集：https://g0v.hackpad.tw/4nashhbYi72
...
實體場域與空間的線上標註
https://g0v.hackmd.io/EOuYzZ-dQIWo7J-E8dPB7A
地理實體動態展現
蒐集各種展現地理資料的方案
...
定位方式
地理 + 資料：各自有許多種呈現的規格
三詞地址：https://what3words.com/zh-hans/our-story/
...
6.其他地理位置的表達方式	6.移動方向，例如車流方向、風向	
...
1.需要人工畫地圖形狀的功能，因為地理形狀也是該主題中重要的資訊。
