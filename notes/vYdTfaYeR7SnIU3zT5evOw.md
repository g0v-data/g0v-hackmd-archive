...
現階段僅會不定期清理 untitled，超過一周以上未編輯（或僅有測試訊息）且無 Owner 的 Note，其餘不做更動。

加入方式：待訂

### 內容違規標準與因應措施（草稿中，歡迎共筆）

標的：公開頁面（若是個人私人頁面，管理者與一般人也看不到..）
標準：內容違規標準
- 頁面內容違反 CoC
...
> 會適合用 google 表單來收檢舉嗎，必填勾選或填寫檢舉理由；挑選可公開欄位（管理員處理狀態）
- 「超級管理員」要做什麼？
    - 目前的超級管理員：ipa, Ronny, CL, isabel, kirby , analeigh
    - 評估「是否違規？」
    - 評估「違規頁面處理方式？」
        - 評估後將該頁面的瀏覽權限設為僅擁有者可瀏覽
        - 評估後刪除該段落或圖片，保留此頁面
        - 評估後刪除該頁面
    - 進行刪除動作之前
        - 超級管理員要不要頁面截圖留存？
