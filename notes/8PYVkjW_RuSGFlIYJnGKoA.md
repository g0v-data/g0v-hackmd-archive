...
* 討論區
  ...
  * 查看自己回覆的討論串中，有在更新
  * 可以收藏討論串
* 弱點分析(需要完成?次模擬測驗) 良:30題的話一次就可以分析
  ...
  * 垃圾桶(刪除題目)  
* 會員中心
  * 可以登入/註冊 良:登入方式google/un+pw/
  * 基本資料 良:可能需要性別、在校/實習/社會、郵件/手機(忘記密碼)、郵遞區號
  * 其他設定 良:可設定要分享自己成績對象
...
---
進良: 現在腦力不濟只想到一點
使用者sign-up後需要簽使用同意書(我們也需要適當保護自己)
