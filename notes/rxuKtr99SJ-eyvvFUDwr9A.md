...
- 方法論：
    ...
    - 視覺化
    - 放到 vTaiwan 的平台上
    - 歡迎針對方法論提出建議！[name=peter]
- 定期檢視：
    - 運用大松與其他活動的機會展開討論與檢視
        - 8/17 面海松
        - 9/23 貝德斯曼基金會研討會
    - 與公民團體、社群專案合作，運用討論來測試不同的工具
    - 舉辦實體社群聚會
    - 利用在台灣舉辦的活動，例如 rightsCon 來做這件事。
- 訪談的對象：
    - 許恩恩
    - 蔡淑芳引導師
    - 熱吵民主協會
    - 青年署公共參與組
    - 更新可以到 [訪談共筆](/qFQk8OaGROyqBuzf8UUe5A)
- 
- 涵蓋範圍：
    - 各國的平台與工具
    - 平台與工具分開討論
        - 平台：經營者是誰？是否有公共資金支持？對象與利用目的為何？是否有法制內容
        - 工具：是否開源？收集個資程度？資料匯出與分析的程度？
    - 有關分析標準的更新，歡迎到[標準收集](/PHkctw6IRgeqbtdfrLCuBQ)！
...
- 更新請到 [整合介紹區](/JH7ecOD9RQiFQBzLw-T03g)
...
- 更新請到 [個別工具資訊整理](/tLkFGP2QSMOjQijxYsg7yA)
## 相關文章
...
- 更新請到 [相關文獻整理](/Fz9Td6-WQyOx8S9zB2hcCA)

## 0720 大松討論
- 有關檢視標準
- [開源軟體工具的啓發式分析]()
- 在使用者訪談之前可以做到的事情
    - 使用人類的語言：在使用者介面上，應使用自然語言。
    - icon 不要令人困惑。
    - 簡單但完整
    - 隱私說明
