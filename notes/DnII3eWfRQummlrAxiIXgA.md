...
* Increased Coverage: It can be very tiring on the part of the tester to execute large amounts of test cases, and in case like this certain test cases are overlooked because they are considered unimportant, this can lead to a major issue but through the use of Automated testing, a large number of test cases can be executed under a short period of time. 
