...
- [數位公共參與工具比較協作共筆](/@Pno233SAS8G5UfL5OvSRmA/SkXZk8UdR)
    - 大松提案簡報
    - 表格與翻譯
    - 訪談分享 [訪談共筆](/qFQk8OaGROyqBuzf8UUe5A)
### 許恩恩訪談回饋
- 死刑替代方案公民參詳的QA 集的用途為何？[name=T]
    - 想要做 vTaiwan 版本的主持人訓練手冊 [name=peter]
- 覺得在多方利害關係人的討論中，數位工具可以幫上更多的忙。同意大場合的狀況中，利用數位工具可以擴大表達的空間，小場合的時候確實有更好的方式來處理表達意見的流程。可能一個更好的方式是用大場合的方式找出分組，再用小場合的方式觀察深度。[name=josh]
    - 類似之前在 [vTaiwan in TicTEC 2024](/_fWuILaRSv-h3FQsXSLxaQ)工作坊實作的方式 [name=peter]
    - 在瑞士有做類似的嘗試，先用數位工具分組討論之後，再打散做異質性的討論。[name=josh]
- 小小的歸納：三個影響大家參與的面向：動機（motivation）、能力（capabiity）跟審議的品質（quality）恩恩的分享比較聚焦於品質。
- assumptions: 預設數位工具會讓參與者的討論品質更好？
    - 數位工具是否有讓參與者更加 informed? 
        - 參與者對於他人的意見與社會上的意見可以更熟悉。[name=peter]
    - slido 能夠幫助公務員更好表達的案例，代表匿名性可能會讓大家更能表達意見。  
- 使用 miro 來做公共議題的案例 [name=T]
    - 來問問看雨蒼 [name=peter]
