...
如果大家想要分享的話，歡迎使用以下文案與圖片！
:::info 
vTaiwan 是一個致力於利用數位工具進行公共討論的社群，今年與臺灣網路資訊中心（TWNIC）合作，希望延續數位發展部三月發布的「人工智慧風險影響評估——兒少篇」中對於人工智慧對兒少風險的觀察，擇定「人工智慧生成之兒少不宜內容」作為深入討論的主題。

今年的 vTaiwan 一樣與臺灣網路資訊中心合作，舉辦審議大會活動討論科技治理相關議題！本次的審議大會議題從數發部今年三月發布的「人工智慧風險影響評估-兒少篇」出發，討論一個風險影響與頻率都很高的情境：「AI 生成／散佈兒少不宜內容」。我們的第一場活動會在 7/17 晚上舉辦，第二場會在 9/11 晚上進行。我們希望藉由這兩輪的活動，討論出人工智慧時代下，如何因應兒少內容的這一個風險！

當生成式 AI 讓內容創作與傳播變得更加容易，我們該如何界定平台、開發者、家長、教育工作者與政府各自應承擔的責任？面對可能對兒少造成傷害的內容，哪些預防、通報與治理措施最有效，同時又能兼顧隱私、創作自由與科技創新發展？你認為未來應該如何取得平衡？

在本次活動中，我們預計採取 vTaiwan 討論模式邀請多元利害關係人進行深入討論。方法為先以線上平台 polis 進行意見徵集後，邀請多元利害關係人參與後續的實體＋線上討論。在實體＋線上討論時，為了使實體與線上的參與者可以享有更好的討論品質，將會使用互動式投影片 mentimeter 與結合人工智慧的數位工具輔助進行討論！目前我們預計在台北舉辦兩場的討論，日期分別是 7/17 週五晚上 18:30-21:30，以及 9/11 週五晚上 18:30-21:30。

如果可以實體 / 線上出席本次活動，歡迎透過以下連結報名參與！
https://docs.google.com/forms/d/e/1FAIpQLSfZ7ZtrXB841V8Jv7eY0fFvB8N9QvihaNEoO1t8H_daKxt6oQ/viewform?usp=dialog 

也歡迎到本次討論前意見徵集使用的 polis 連結中參與線上的意見徵集！
https://polis.tw/9xeamzkbjp
:::
...
https://www.vtaiwan.tw/transcription_detail/20260624
...
### 1. 平台與資料匯出  
- **Polis.tw 連結已建完成**，已上傳至聊天室，使用官網 `polis.tw` 的伺服器。  
- **TWINC 的隱私顧慮**：雖然 Polis 資料屬非識別化，但 TWINC 要求在說明中加註隱私聲明，已完成註記。  
- **Analyst & Insight 報告**：此功能需付費才能直接匯出 data‑report。  
- **資料匯出問題**：  
  - 目前 `polis.tw` **不支援** 直接從 URL 匯出資料（Bestian 於會中說明）。  
  - `Pol.is`（國際版）功能較完整，可匯出，且支援與 SenseMaker 的資料相容。  
  - 決議：**將現有意見資料遷移至 Pol.is**，並在 Polis.tw 的說明頁面更新新連結（Bestian 建議的文字說明）。

### 2. 參與者招募與推廣  
- 已發佈報名表單，截止目前 **13‑14 位**參與者。  
- 推廣渠道：  
  - 協會、公共科技組織、G0V 社群、V 台灣等。  
  - 正在接觸科技平台業者、書發部、政府官員。  
- 目標：持續擴散，爭取更多參與者與合作夥伴。

### 3. 議題規劃與研究資料  
- **主要議題**：AI 時代的兒童性剝削（CSEA）  
  - 參考 **UNICRI 報告** 及 6 份相關文獻，決定以其中一篇為簡報骨架。  
- 已聯繫 **展示協會**（台灣兒少性虐待研究單位），邀請理事長擔任講者並提供最新分析資料。  
- 議題稿件預計 **下週二晚上**完成，屆時分享給全體成員。

### 4. 工作流程與工具衝突  
| 工具 | 用途 | 可能衝突 | 解決方案 |
|------|------|----------|----------|
| **Mentimeter** | 破冰、即時投票、收集意見 | 需要參與者手機同時操作，與大螢幕互動時可能干擾 | 只能在 **Mentimeter Session** 使用，結束後切換至 Hear the Room |
| **Hear the Room (HearAgora)** | 收集討論文字回饋與投票 | 同樣需要終端設備，與 Mentimeter 同時使用會產生衝突 | **分段 Session**：先用 Mentimeter 破冰，之後切換至 Hear the Room 完成深度討論 |

- 參與人數估計 **上百人**，需測試兩套工具的同時負載能力（已確認 Mentimeter 50 人可用）。
- **預算**：今年活動預算已列入，可購買 Mentimeter 訂閱以支援後續分析與匯出。

### 5. 重要活動行事曆  
| 日期 | 活動 | 形式 | 備註 |
|------|------|------|------|
| **7 月 22 日** | 台北 & 花蓮兩場會議 (2 小時) | 現場 + 線上 | 花蓮會議主題較貼合當地需求 |
| **9 月 11 日** | 6:30 PM (台灣時間) 直播 | 線上 | 配合瑞士時間 11:30‑14:30 |
| **7 月 17 日** | 與尼日利亞 **Tunani Initiative** 合作的 AI 與公聽會分享 | 可能線上/混合 | 需要確定講者與 Demo 內容 |

### 6. 與國際合作（Tunani Initiative）  
- 目標：在尼日利亞公聽會制度上示範 **AI 結合公聽會** 的案例。  
- 需求：一位台灣講者（技術 Demonstration）+ 簡報（由崔家瑋準備）。  
- 已與對方安排 **quick call**（台灣時間 19‑21 h）確認細節與參與人數。  
- 若時間不足，可僅安排 **一位講者**（技術演示）而非兩位。

### 7. 後續行動與分工  
1. **平台遷移**：完成 Pol.is 連結更新與說明稿（Bestian 監督）。  
2. **議題稿件**：崔家瑋於下週二完成並共享。  
3. **測試負載**：Josh 负责 Mentimeter 及 Hear the Room 的壓力測試，確認 100+ 參與者同時使用情況。  
4. **預算申請**：OCF 负责匯款與資金分配，確保 Mentimeter 訂閱費用到位。  
5. **宣傳推廣**：持續在 G0V、V 台灣、協會等渠道張貼報名表，爭取更多參與者。  
6. **國際合作 Demo**：崔家瑋負責製作 PPT、技術 Demo（Hear the Run、Civic Talk、Mentimeter）; Joshua 提供現場收音與技術支援。  

---

### 結語
- 本次會議決議**資料遷移至 Pol.is**、**優化工具使用流程**、**確保資金與技術支援**，並持續推進國際合作與議題研發。  
- 請各負責人依照上述行動項目於下週內回報進度，確保 7/22 活動與 7/17 尼日利亞 Demo 能順利執行。