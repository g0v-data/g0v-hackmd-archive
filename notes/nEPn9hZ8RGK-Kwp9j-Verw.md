...
tags: g0vernance
---
da0 GitHub 申請規範 v0.1
====================

文件更新歷程
------------
* v0.1 - 2022/12/24 從 [g0v GitHub 申請規範 v0.1](https://g0v.hackmd.io/I4_oYRIvT9S0RKufKKKKvg?edit) 複製過來


範圍
----
本文件處理 da0 社群需要的 GitHub organization，以便程式碼管理，社群內願意參與配合皆可以加入本 Guidelines
...
* 建議在專案的 Repository 內加入 [da0.json](https://github.com/da0/da0.json) 文件
