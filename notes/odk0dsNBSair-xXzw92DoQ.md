...
一、整體方向
•	TWNIC 對今年暑假 續辦 2 場活動有興趣
•	主題聚焦：AI
•	認為「AI 公眾諮詢」是長期議題，可能未來 5 年都會持續進行
•	新想法：
→ 嘗試在 東部（花蓮）辦一場
→ 需評估時程與執行可行性

二、初步時程規劃
•	四月底前：vTaiwan 提交提案，然後TWNIC確認時間
•	7 月：台北 AI 第一場
•	8 月：台北 AI 接力場
•	9–10 月：花蓮場（這時天氣較舒適）
→ 需額外規劃與資源投入
...
•	「Scale（規模）」是反覆被提到的挑戰
•	討論方向：
→ 是否可以設定 約 500 人規模（TWNIC 表示 願意支持經費場地等等）

五、工具與技術想法
•	新工具？Mentimeter 的即時留言（畫面右下角浮動留言）是否能整合進討論流程，成為正式 deliberation input？
