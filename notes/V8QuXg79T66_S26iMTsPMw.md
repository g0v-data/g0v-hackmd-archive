...
https://www.vtaiwan.tw/transcription_detail/20260506


### AI大綱

**會議重點整理（2026/05/06 19:03 – 19:33）**  

---

## 1. 會議概況
- **主持人**：崔家瑋  
- **會議時間**：約 30 分鐘（19:03 起）  
- **特別說明**：主持人 19:30 必須提前離開，後續會交由 Rolf Miller 主持。  
...
| 姓名 | 身份/角色 | 關鍵字/專長 |
|------|-----------|-------------|
| **Peter (V 台灣社群貢獻者)** | 研究生、法律、AI |  |
| **泰偉** | 新成員 |  |
| **Tim** |  |  |
| **Josh** |  |  |
| **其他** | 包含師伯 Billy、Rolf Miller、Yitin Lian 等 |  |

> **註**：因參與者較多，簡短自介後即進入會議議題。

---

## 3. 共享文件與資源
- **共筆連結**：已放入聊天室，供有編輯權限者即時更新。  
- **Hackend 文件警示**：  
  - 有人利用 SEO 賬號造假、產生虛假共筆關係。  
  - 新成員加入社群需先等 **2 個月**，才會有 manager 主動調整設定。  
- **電子報**：  
  - 已完成 **第 0 期** 初稿（「回顧與持續參與的工具」）。  
  - 內容包括：專案概況、Polis 討論、數位科技周報、活動資訊。  
  - 想要取得編輯權限者可向主持人索取文件權限（文件掛於 V 台灣底下）。
- **SenseMaker（V3）**：  
  - Bestian 設計的本地化插件，已整合至 `make.mp.taiwan.tw`。  
  - 可結合 Polis 收集的意見，透過 AI (OpenAI 等) 進行整理與視覺化。  
  - 相關說明文件已放在共筆，歡迎編輯或提供建議。

---

## 4. 重要討論議題
1. **Polis 專案回顧**  
   - 2014 年「逼台灣」的 Polis 版圖 → 現在的 Polis 2.0 / 延伸應用。  
   - 強調 **意見群聚** 與 **數學運算**（非語義分析），用於視覺化與證據整理。  

2. **AI 與公民科技報告**  
   - 2024 年與英國 TICTAC 活動合作的《Shifting Landscape – AI & Civic Tech》報告已放入素材庫。  
   - 內容涵蓋 POLIS 歷史、AI 促進民主的可能性，供未來電子報引用。  

3. **即將舉辦的活動**  
   - **Taiwan Internet Week**（7 月）——預計在花蓮舉辦 3 場活動。  
   - 正與當地社工、審議活動社群（GIN、比台灣等）討論合作與資訊串流。  
   - 需要設計視覺化主題、簡報素材，已與 TFG (TFGA) 協調時間與場地（台大醫院會議中心）。  

4. **AI 協作流程規劃**  
   - 先建置文字模板（前 15 篇電子報）作為基礎，之後評估自動化工具。  
   - 目標：將資訊整理工作機械化，提升產出效率。  

---

## 5. 其他備註
- **Rolf Miller** 會在會後繼續分享最新動向，參與者可自行與其交流。  
- **遠距參與**：多場議程支援線上參與，設備已備妥，無需擔心連線問題。  
- **群照**：會議結束前已完成全體截圖留念。  

---

**結語**：會議主要聚焦於社群自我介紹、文件資源共享、即將舉辦的活動規劃、以及 AI/公民科技相關的資訊整理與工具建置。上述行動項目請依負責人持續追蹤，確保 5/11 前完成 Internet Week 的準備工作。若有任何疑問或需要協助，請直接聯繫主持人崔家瑋。  