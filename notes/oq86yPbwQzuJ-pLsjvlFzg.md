...
:::warning
NOTE: 左上角按 + 開新的 Hackmd ，然後把這個模板全部複製貼過去就可以開始改了。不要直接改在這裡喔！
:::
...
這邊是讓你放專案的簡介，專案的簡介可以放這裡，還有各式各樣不同的專案，你想像得到的專案簡介，不管他這麼長，或是這麼短，只要他是專案簡介，而且應該可以讓別人看得懂，你都可以嘗試用各種你想得到的方式，放在這裡。
...
- [X](/HAn_R3IrR2ONHXJebCSSQQ) NeedsDesigner: 需要介面設計
