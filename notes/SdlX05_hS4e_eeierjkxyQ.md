...
<https://g0v.hackmd.io/@chewei/SJeTRFyFYp/>（申請 HackMD Team 團隊中，此為暫定地址）
...
:::info
本文件基於 [HackMD](https://hackmd.io) 的書本模式 (Book Mode)，編輯方式請參閱 [Book example - HackMD](https://hackmd.io/book-example) 以及目錄下方之教學
...
* [Shelter 消防署釋出避難收容處所點位檔案-20240107](https://app.awesome-table.com/-NnYWzaRVwV_CasaZLAV/view)  
  視覺化顯示當前避難收容處所資料的 Awesome Table 應用
* [Shelter 消防署釋出避難收容處所點位檔案-20240107](https://docs.google.com/spreadsheets/d/1l_Au7txDgsknhHKvhLksfSAzeMmSoaih3m4pMdqwrBU/edit)  
  整理待提交勘誤資訊用的 Google 試算表

## 輔助工具<br>Utilities

* [Google 地圖](https://www.google.com/maps) [target=_blank]  
  查詢地標的經緯度等資訊
* [中華民國 內政部戶政司 全球資訊網 - 村里街路門牌查詢](https://www.ris.gov.tw/app/portal/3053) [target=_blank]  
  查詢特定地址位於哪一個村里的範圍
