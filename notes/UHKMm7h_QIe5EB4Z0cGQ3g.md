...
- 2024-09-16 20:09:26.485 收到答覆
  ...
  - 呼叫 1 次 SetCooccurrences，建立下面 cooccurrence
    ```js
    {
      "articleIds": [
        "A8A_vAfgP9gEID_8P_w9AP_5P_g_AAAA__8AAAAAAAA", // 錯的，奇妙的疫苗文
        "EynRB4kBFLWd9xY2Ohxi", // 奇妙的台灣人窮了
        "yRGx-pEBUOXjqM1ArxO7", // 晚上攤販
        "yhGx-pEBUOXjqM1AsxP0" // 開源祭
      ],
      "createdAt": "2024-09-16T12:09:37.565Z",
      "updatedAt": "2024-09-16T12:09:37.565Z"
    }
    ```
...
分析：
- 關鍵應是「4 次 ListArticlesInProcessMedia」是否有找到對的文章
